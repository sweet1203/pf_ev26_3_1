 ...
 * sourceAssessment: 수행평가용 안내 페이지에만 쓰는 짧은 출처 설명(학생용).
 */
export const DATASET_CATALOG = [
  {
    ...
    sourceAssessment:
      '**출처:** Kaggle 등에 공유된 학습용 데이터입니다.\n**어떤 데이터:** 시험 과목 점수와 가정 배경 등이 적힌 표입니다.\n**실제/가상:** 특정 학교 실명이 아니라, 통계·그래프 연습용으로 만든 **익명·가상에 가까운 예시**로 이해하면 됩니다.',
    g2: { rows: 1000, cols: 8 },
    g3: { rows: 1000, cols: 8 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** UCI(머신러닝 공개 저장소) 등에 올라온 **포르투갈 학생** 설문·성적 자료입니다.\n**어떤 데이터:** 공부 시간, 결석, 가족 환경과 성적이 적혀 있습니다.\n**실제/가상:** 예전에 **실제 설문·성적 형태로 모은 뒤 익명 처리한 연구용 데이터**를 수업용으로 줄인 것입니다.',
    g2: { rows: 395, cols: 6 },
    g3: { rows: 395, cols: 12 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** Kaggle 등에 공유된 **수면·건강·생활 습관** 관련 데이터입니다.\n**어떤 데이터:** 수면 시간, 스트레스, 직업 같은 항목이 적혀 있습니다.\n**실제/가상:** **병원 진료 기록이 아닙니다.** 설문이나 컴퓨터로 만든 **가상·예시에 가까운 학습용 표**로 보면 됩니다.',
    g2: { rows: 374, cols: 13 },
    g3: { rows: 374, cols: 13 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** 인도 쪽 **공공기관·개방 데이터**를 모아 Kaggle 등에서 공유한 버전을 수업용으로 다시 정리한 것입니다.\n**어떤 데이터:** 도시, 날짜, 미세먼지·가스 농도 등이 적혀 있습니다.\n**실제/가상:** **실제 대기 측정값에 가깝게 공개된 숫자**를 모은 것입니다. (우리 파일은 행·열을 수업에 맞게 손댄 버전입니다.)',
    g2: { rows: 416, cols: 16 },
  ...
  },
  {
    ...
    sourceAssessment:
      '**출처:** **세계행복보고서**(World Happiness Report)에 나온 나라별 지표를 표로 정리한 데이터입니다.\n**어떤 데이터:** 행복 점수, GDP, 건강, 사회적 지지 등이 나라마다 적혀 있습니다.\n**실제/가상:** **실제 설문·통계를 요약한 공개 보고서**를 바탕으로 한 자료입니다.',
    g2: { rows: 156, cols: 9 },
    g3: { rows: 156, cols: 9 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** Tableau 등에서 배포하는 **가상 마트(Superstore) 예시 데이터**입니다.\n**어떤 데이터:** 제품 분류, 지역, 매출, 이익 등이 적혀 있습니다.\n**실제/가상:** **실제 회사 장부가 아니라**, 그래프·분석 연습용으로 만든 **가상 샘플**입니다.',
    g2: { rows: 2000, cols: 5 },
    g3: { rows: 5000, cols: 8 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** Kaggle 등에 올라온 **넷플릭스 작품 목록**을 가져와 수업용으로 줄인 데이터입니다.\n**어떤 데이터:** 영화/시리즈 구분, 국가, 공개 연도, 등급 등이 적혀 있습니다.\n**실제/가상:** **실제 서비스에 있던 작품 정보와 비슷하게 모은 표**이지만, 넷플릭스가 공식으로 준 전체 목록은 아닐 수 있습니다.',
    g2: { rows: 1808, cols: 5 },
    g3: { rows: 2283, cols: 8 },
  ...
  },
  {
    ...
    sourceAssessment:
      '**출처:** Kaggle 등의 **“유튜브 인기 동영상 통계”** 데이터를 수업용으로 정리한 것입니다.\n**어떤 데이터:** 조회수, 좋아요, 카테고리, 채널 이름 등이 적혀 있습니다.\n**실제/가상:** **실제 플랫폼에서 수집한 숫자에 가깝지만**, 유튜브가 직접 배포한 공식 전체 데이터는 아닙니다.',
  ...
  },
  {
    ...
    sourceAssessment:
      '**출처:** Kaggle 등에 공유된 **키·몸무게·체형** 연습용 데이터입니다.\n**어떤 데이터:** 성별, 키, 몸무게, 체형 등급이 적혀 있습니다.\n**실제/가상:** **전 국민 실명 조사가 아닙니다.** 그래프 연습용으로 만든 **샘플·가상에 가까운 예시**인 경우가 많습니다.',
    g2: { rows: 500, cols: 4 },
    g3: { rows: 500, cols: 4 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** UCI 등에서 공개한 **심장 질환 분류 연습용** 데이터입니다.\n**어떤 데이터:** 나이, 혈압, 콜레스테롤, 질환 여부(예/아니오) 같은 항목이 적혀 있습니다.\n**실제/가상:** **실제 병원 기록 형태를 단순화한 예시**이지만, **진단·치료에 쓰는 데이터가 아닙니다.** 수업용 표로만 씁니다.',
    g2: { rows: 900, cols: 6 },
    g3: { rows: 900, cols: 14 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** 뉴욕시 등에서 **공개한 우버 운행 집계** 자료를 바탕으로 한 데이터입니다.\n**어떤 데이터:** 날짜마다 활성 차량 수, 운행 건수가 적혀 있습니다.\n**실제/가상:** **실제 공개 통계에 가까운 숫자**를 수업용으로 일부만 가져온 것입니다.',
    g2: { rows: 354, cols: 4 },
    g3: { rows: 354, cols: 4 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** Kaggle 등에서 많이 쓰는 **타이타닉 승객 생존** 학습용 표입니다.\n**어떤 데이터:** 객실 등급, 성별, 나이, 생존 여부 등이 적혀 있습니다.\n**실제/가상:** **1912년 실제 사건을 바탕으로 한 기록을 요약한 데이터**입니다. 세부는 영화·책과 다를 수 있습니다.',
    g2: { rows: 714, cols: 5 },
    g3: { rows: 714, cols: 8 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** 통계·머신러닝 교과서에서 유명한 **붓꽃(Iris) 실험 데이터**(UCI 등 공개)입니다.\n**어떤 데이터:** 꽃받침·꽃잎 길이·너비와 품종 이름이 적혀 있습니다.\n**실제/가상:** **실제 꽃을 재어서 만든 과학 실험 데이터**입니다.',
    g2: { rows: 150, cols: 6 },
    g3: { rows: 150, cols: 6 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** 남극 **팔머 기지 연구**에서 모은 펭귄 측정 데이터를 정리한 교육용 표입니다.\n**어떤 데이터:** 펭귄 종, 서식지, 부리·날개·체중 등이 적혀 있습니다.\n**실제/가상:** **실제 동물을 관측해 모은 생태 데이터**를 수업용으로 줄인 것입니다.',
    g2: { rows: 333, cols: 7 },
    g3: { rows: 333, cols: 7 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** 예전에 한 식당에서 모은 **팁·계산서 습관**을 담은 표가 통계 예제로 널리 쓰입니다.\n**어떤 데이터:** 총액, 팁, 성별, 요일 등이 적혀 있습니다.\n**실제/가상:** **실제 매장 패턴을 단순화한 작은 표**에 가깝고, 그래프 연습용으로 씁니다.',
    g2: { rows: 244, cols: 7 },
    g3: { rows: 244, cols: 7 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** 통계 교재에서 유명한 **국제선 항공 월별 승객 수**(1949~1960년) 데이터입니다.\n**어떤 데이터:** 연도, 월, 승객 수(천 명 단위)가 적혀 있습니다.\n**실제/가상:** **그 시절 실제 항공 통계를 바탕으로 한 시계열 예시**입니다.',
    g2: { rows: 144, cols: 4 },
    g3: { rows: 144, cols: 4 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** 통계 소프트웨어(R의 ggplot2 등)에 들어 있는 **다이아몬드 가격·등급 예시**입니다.\n**어떤 데이터:** 캐럿, 컷·색·선명도 등급, 가격 등이 적혀 있습니다.\n**실제/가상:** **실제 보석 장부가 아니라** 그래프 연습용 **가상·샘플 데이터**입니다.',
    g2: { rows: 2000, cols: 5 },
  ...
  },
  {
    ...
    sourceAssessment:
      '**출처:** 그래프 예제용으로 널리 쓰는 **운동·맥박 실험 형태의 표**(Seaborn 등)입니다.\n**어떤 데이터:** 식이 구분, 운동 종류, 맥박, 측정 시점이 적혀 있습니다.\n**실제/가상:** **병원 검사 결과가 아니라** 패턴을 보기 위한 **가상·실험 예시 데이터**입니다.',
    g2: { rows: 90, cols: 5 },
    g3: { rows: 90, cols: 5 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** 오래전부터 통계 교재에 나오는 **자동차 연비(MPG)·마력·중량** 데이터입니다.\n**어떤 데이터:** 연비, 기통 수, 배기량, 중량, 제조 지역 등이 적혀 있습니다.\n**실제/가상:** **옛날 실제 차량 정보를 바탕으로 한 공개 예시**이지만, 지금 사는 차와 직접 비교하긴 어렵습니다.',
    g2: { rows: 392, cols: 9 },
    g3: { rows: 392, cols: 9 },
  },
  {
    ...
    sourceAssessment:
      '**출처:** 그래프 라이브러리 Seaborn의 **미국 주별 교통·보험 요약 예시**(car_crashes)입니다.\n**어떤 데이터:** 주 이름, 사고율, 과속·음주 비율, 보험료 등이 적혀 있습니다.\n**실제/가상:** **공개된 통계를 바탕으로 만든 교육용 표**이며, 정부 공식 보고서와 똑같다고 보긴 어렵습니다.',
    g2: { rows: 51, cols: 5 },
    g3: { rows: 51, cols: 8 },
  },
];
