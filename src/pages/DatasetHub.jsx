      ...
      <div className="rounded-2xl shadow-xl overflow-hidden border border-slate-200 bg-white mb-8">
        <div className="px-6 py-8 text-white bg-gradient-to-br from-slate-700 to-slate-900">
          ...
          <p className="mt-3 text-sm sm:text-base opacity-95 max-w-2xl leading-relaxed">
            용도에 따라 페이지를 나누었습니다. <strong>수행평가 제출</strong>에는 반드시 수행평가용 CSV를 사용하고,{' '}
            <strong>연습·Orange 실습·결측 처리 학습</strong>에는 연습용 CSV를 사용하세요. 각 페이지에서 학년(2·3)을
            선택할 수 있습니다.
          </p>
        </div>
      </div>

      <div className="grid gap-5 sm:grid-cols-1 sm:max-w-none">
        <Link
          to="/datasets/assessment"
          className="group block rounded-2xl border-2 border-teal-200 bg-gradient-to-br from-teal-50 to-white p-6 sm:p-8 shadow-sm hover:shadow-md hover:border-teal-400 transition-all"
        >
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="text-xl font-bold text-teal-950 flex items-center gap-2 flex-wrap">
                수행평가용 데이터셋
                <span className="text-sm font-semibold text-teal-800 bg-teal-100 px-2 py-0.5 rounded-md">
                  제출 시 사용
                </span>
              </h2>
              <p className="mt-2 text-sm text-slate-700 leading-relaxed">
                결측이 정리된 CSV입니다. 리로스쿨 제출·본 수행평가 분석에 이 파일을 사용하세요. 2학년(정보)과 3학년(빅데이터분석)
                탭으로 전환해 다운로드합니다.
              </p>
              <p className="mt-4 text-sm font-semibold text-teal-800 group-hover:underline">페이지 열기 →</p>
            </div>
          </div>
        </Link>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-2 text-sm text-slate-700 leading-relaxed">
                ...
                가이드·결측 처리 학습에 활용하세요. 공식 제출에는 사용하지 마세요.
              </p>
